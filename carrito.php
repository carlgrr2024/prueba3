...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="./">Seguir comprando</a>
    ...
    <!-- Header-->
    <header">
    <img  width="1370" height="280"  src="carr.jpg">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Todos los derechos de autor reservados &copy; Proyecto final</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
